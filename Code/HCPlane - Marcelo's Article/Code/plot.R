...
readingMPR<-function(dimension,option=0){
  if(dimension == 3){ 
    continua = "../Data/HCPlane/continuaN6.txt"
    trozo = "../Data/HCPlane/trozosN6.txt"
  }
  if(dimension == 4){ 
    continua = "../Data/HCPlane/continuaN24.txt"
    trozo = "../Data/HCPlane/trozosN24.txt"
  }
  if(dimension == 5){ 
    continua = "../Data/HCPlane/continuaN120.txt"
    trozo = "../Data/HCPlane/trozosN120.txt"
  }
  if(dimension >= 6){ 
    continua = "../Data/HCPlane/continuaN720.txt"
    trozo = "../Data/HCPlane/trozosN720.txt"
  }
