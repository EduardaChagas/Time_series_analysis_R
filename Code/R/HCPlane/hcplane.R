...
HCPlane <- function(p, Entropy.Complexity, dimension){
  ...
  p = p + 
    geom_segment(aes(x=Entropy.Complexity$Entropy[1:6],
                     xend=Entropy.Complexity$Entropy[2:7],
                     y=Entropy.Complexity$Complexity[1:6],
                     yend=Entropy.Complexity$Complexity[2:7]), linetype="dotted") +
