...
%O desequilı́brio Q  refletir a “arquitetura” de um sistema, sendo diferente de zero se houver alguma estrutura que seja “privilegiada”, ou estados que sejam mais prováveis entre os acessı́veis. Ele é definido em termos da Divergência de Jensen-Shannon J [P, P e ], cuja escolha é discutida em [17]. Então,
